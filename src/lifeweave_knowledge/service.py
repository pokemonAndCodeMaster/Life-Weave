...
from .repository import LifeWeaveKnowledgeRepository
...
class LifeWeaveKnowledgeService:
    ...
    def __init__(self, repository: LifeWeaveKnowledgeRepository, roots: dict[str, Path | None], lifeweave_service: Any) -> None:
    ...
    def _check_verification(self, workspace: str, candidate: dict[str,Any], body: dict[str,Any]) -> None:
        ...
        evidence=next((e for e in self.lifeweave_service.repository.list_evidence(workspace,item_id) if e['id']==body['evidenceId']),None)
