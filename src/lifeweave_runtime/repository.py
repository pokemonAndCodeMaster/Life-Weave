...
class LifeWeaveRuntimeRepository:
    ...
    def __init__(self, postgres: PGConnector) -> None:
        ...
        self._machines = f"{schema}.t_lifeweave_machine"
        self._runs = f"{schema}.t_lifeweave_run"
        self._events = f"{schema}.t_lifeweave_run_event"
