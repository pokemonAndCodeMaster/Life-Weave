...
class LinearService:
 ...
 def import_issue(self,workspace,identity):
  ...
  with self.db.transaction() as conn:
   ...
   payload={'goal':remote['description'] or remote['title'],'scope':'从 Linear 引入，在 LifeWeave 中推进；本地状态与原事项分别维护。','owner':'我','due':remote.get('dueDate'),'priority':remote['priority'],'linearUrl':remote['url'],'linearIdentifier':remote['identifier']}
