...
interface Settings { executors:Record<string,{available:boolean;version?:string;reason?:string}>;linearConfigured:boolean;existingCredentialAvailable:boolean;identityMode:string }
