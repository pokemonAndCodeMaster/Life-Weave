...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/lifeweave/:workspace(personal|team)/items/:itemId/:tab(overview|context|outputs|activity|retro|development)?', name: 'item-detail', component: () => import('@/features/lifeweave/pages/ItemDetailPage.vue'), meta: { lifeweave: true, title: '事项' } },
